...
exports.register = async(req,res) => {
  try{
    res.render("client/register",{span:"",layout:false})
    }
  catch(error){
    res.send("failed to load login form"+error);
  }
...
exports.about = async(req,res) => {
  try{
    res.render("client/about",{layout:false});
  }
  catch(error){
    res.send("failed to load about"+error)
  }
}

exports.contact = async(req,res) => {
  try{
    res.render("client/contact",{layout:false});
  }
  catch(error){
    res.send("failed to load contact"+error)
  }
}

exports.sample = async(req,res) => {
  try{
    res.render("client/sample",{layout:false});
  }
  catch(error){
    res.send("failed to load contact"+error)
  }
